                                    ...
                                    <div class="form-row">
                                        <div class="col-3">
                                            ...
                                            <div class="input-group input-group-sm mb-3">
                                                <input type="text" class="form-control dpd2a rounded-0"
                                                    id="fromdateFilter" name="fromdateFilter" value="2025-02-01"
                                                    required>
                                        ...
                                        <div class="col-3">
                                            ...
                                            <div class="input-group input-group-sm mb-3">
                                                <input type="text" class="form-control dpd2a rounded-0"
                                                    id="todateFilter" name="todateFilter"
        ...
        $('#dataTable').DataTable({
            ...
            "buttons": [{
                ...
                },
                {
                    ...
                    ext: '<i class="fas fa-print mr-2"></i> Print'
                }
            ],
                "paging": true,
                "searching": true,
            ...
            ajax: {
                url: "scripts/testallporderlist.php",
            ...
            "columns": [{
                ...
                },
                {
                    ...
                    "data": null,
                    "render": function (data, type, full) {
                        return parseFloat(full['discount']);
                    }
                },
                {
                    "targets": -1,
                    ...
                    "data": null,
                    "render": function (data, type, full) {
                        return parseFloat(full['nettotal']);
                    }
                },
                {
                    "data": "status"
