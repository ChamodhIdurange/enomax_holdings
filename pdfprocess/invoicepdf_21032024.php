...
$html = '
    ...
    <body style="margin-top:6.5cm; margin-bottom:5cm; height:14cm">
            ...
            <tr>
                ...
                <td>
                    <table width="100%" height="100%" border="0">
                        <tr><td width="30%" height="0.5cm"> </td><td align="left">' .$today .' </td></tr>
    ...
    if ($resultinvoicedetail->num_rows == $count) {
        $html .= '
        <footer>
            <div style="margin-left: 670px; padding-right: 0px; height: 75px;">
