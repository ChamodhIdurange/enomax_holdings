...
if ($recordOption == 1) {
    ...
    if ($conn->query($insretorder) == true) {
        ...
        foreach ($tableData as $rowtabledata) {
            ...
            $insertorderdetail = "INSERT INTO `tbl_customer_order_detail`(`orderqty`, `total`, `confirmqty`, `dispatchqty`, `qty`,`freeqty`, `unitprice`, `saleprice`, `discountpresent`, `discount`, `status`, `insertdatetime`, `tbl_user_idtbl_user`, `tbl_customer_order_idtbl_customer_order`, `tbl_product_idtbl_product`) VALUES ('$newqty', '$total', '$newqty', '$newqty', '$newqty', '$freeqty', '$unitprice','$saleprice', '$linediscountpercentage', '$linediscount', '1','$updatedatetime','$userID','$orderID','$product')";
            $conn->query($insertorderdetail);

            $insertoriginalorderdetail = "INSERT INTO `tbl_original_customer_order_detail`(`orderqty`, `total`, `confirmqty`, `dispatchqty`, `qty`, `freeqty`, `unitprice`, `saleprice`, `discountpresent`, `discount`, `status`, `insertdatetime`, `tbl_user_idtbl_user`, `tbl_original_customer_order_idtbl_original_customer_order`, `tbl_product_idtbl_product`) VALUES ('$newqty', '$total', '$newqty', '$newqty', '$newqty', '$freeqty', '$unitprice','$saleprice', '$linediscountpercentage', '$linediscount', '1','$updatedatetime','$userID','$originalOrderID','$product')";
