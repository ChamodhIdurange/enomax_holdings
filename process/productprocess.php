...
if ($recordOption == 1) {
    $query = "INSERT INTO `tbl_product`(`product_code`, `product_name`, `size`, `unitprice`, `saleprice`, `status`, `updatedatetime`, `tbl_user_idtbl_user`, `tbl_product_category_idtbl_product_category`, `barcode`, `rol`, `pices_per_box`, `retail`, `starpoints`, `tbl_group_category_idtbl_group_category`, `tbl_sub_product_category_idtbl_sub_product_category`, `tbl_supplier_idtbl_supplier`, `retaildiscount`, `salediscount`, `price_acceptable`, `additional_discount`, `common_name`, `tbl_sizes_idtbl_sizes`, `tbl_size_categories_idtbl_size_categories`, `productimagepath`, `uom`, `buying_qty`, `fre_qty`) Values ('$productcode','$product_name','','$unitprice','$saleprice','1','$updatedatetime','$userID','$category','$barcode','$rol','$peices','$retail','$starpoints','$groupcategory','$subcategory','$supplier','$retaildiscount','$salediscount', '$priceradio', '$additionaldiscount', '$commonname', '$size', '$sizecategory', '$productimagepath', '$uom', '$buyqty', '$freeqty')";
    ...
    $getOldData = "SELECT `unitprice`, `saleprice` FROM `tbl_product` WHERE `idtbl_product`='$recordID'";
